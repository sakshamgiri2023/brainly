import ButtonUi from "../compoenets/ButtonUi/Button";
import SideNavbar from "../compoenets/slideBar/Sidebar";
import ShareIcon from "../compoenets/icons/ShareIcon";
import PlusIcon from "../compoenets/icons/PlusIcon";
import { useContext, useEffect, useRef, useState } from "react";
import type { JSX } from "react";
import Modal from "../compoenets/ModalUi/Modal";
import Card from "../compoenets/CardUi/Card";
    ...
    <div className="flex justify-between">
      <div className="font-bold text-3xl mt-4 ml-8">All Notes</div>
        <div className="flex gap-2 mt-5 mr-8">
          <div onClick={share}>
          <ButtonUi variant="secondary" size="lg" text={"Share Brain"} startIcon={<ShareIcon/>} endIcon={<></>} />
          </div>
